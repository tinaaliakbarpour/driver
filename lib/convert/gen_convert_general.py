...
if __name__ == '__main__':
    ...
    for pax_type, ptr_type in (
        ...
        for in_type, out_type in ((pax_type + '_chdr', pax_type), (pax_type, pax_type + '_chdr')):
    ...
    for end in ('be', 'le'):
        host_to_wire = {'be': 'pax::htonx', 'le': 'pax::htowx'}[end]
        wire_to_host = {'be': 'pax::ntohx', 'le': 'pax::wtohx'}[end]
    ...
    for end, to_host, to_wire in (
        ('be', 'pax::ntohx', 'pax::htonx'),
        ('le', 'pax::wtohx', 'pax::htowx'),
    ):
    ...
    for width in 1, 2, 4:
        for cpu_type, do_scale in (
            ...
            output += parse_tmpl(
                TMPL_CONV_USRP1_COMPLEX,
                width=width, to_host='pax::wtohx', to_wire='pax::htowx',
