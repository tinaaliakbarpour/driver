...
{
    return converter::sptr(new convert_sc12_item32_1_to_star_2<float, pax::wtohx>());
}

static converter::sptr make_convert_sc12_item32_le_1_to_sc16_1(void)
{
    return converter::sptr(new convert_sc12_item32_1_to_star_2<short, pax::wtohx>());
}

PAX_STATIC_BLOCK(register_sse_unpack_sc12)
{
