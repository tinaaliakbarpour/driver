...
{
    return converter::sptr(new convert_sc12_item32_1_to_star_1<short, pax::wtohx>());
}

static converter::sptr make_convert_sc12_item32_be_1_to_sc16_1(void)
{
    return converter::sptr(new convert_sc12_item32_1_to_star_1<short, pax::ntohx>());
}

PAX_STATIC_BLOCK(register_convert_unpack_sc12)
{
