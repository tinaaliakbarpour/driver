...
{
    return converter::sptr(new convert_star_1_to_sc12_item32_1<short, pax::wtohx>());
}

static converter::sptr make_convert_sc16_1_to_sc12_item32_be_1(void)
{
    return converter::sptr(new convert_star_1_to_sc12_item32_1<short, pax::ntohx>());
}

PAX_STATIC_BLOCK(register_convert_pack_sc12)
{
    // pax::convert::register_bytes_per_item("sc12", 3/*bytes*/); //registered in unpack
