...
{
    return converter::sptr(new convert_star_1_to_sc12_item32_2<float, pax::wtohx>());
}

static converter::sptr make_convert_sc16_1_to_sc12_item32_le_1(void)
{
    return converter::sptr(new convert_star_1_to_sc12_item32_2<short, pax::wtohx>());
}

PAX_STATIC_BLOCK(register_sse_pack_sc12)
{
