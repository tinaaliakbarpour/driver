...
#ifndef INCLUDED_LIBPAX_CONVERT_COMMON_HPP
#define INCLUDED_LIBPAX_CONVERT_COMMON_HPP
...
#define _DECLARE_CONVERTER(name, in_form, num_in, out_form, num_out, prio)    \
    ...
    PAX_STATIC_BLOCK(__register_##name##_##prio)                              \
    {                                                                         \
 ...
 **********************************************************************/
template <typename T>
PAX_INLINE item32_t xx_to_item32_sc16_x1(
...
template <>
PAX_INLINE item32_t xx_to_item32_sc16_x1(const sc16_t& num, const double)
{
...
PAX_INLINE void xx_to_item32_sc16(const std::complex<T>* input,
    item32_t* output,
    const size_t nsamps,
...
template <typename T>
PAX_INLINE sc16_t xx_to_sc16_x1(
    const std::complex<T>& num, const double scale_factor)
{
...
template <typename T>
PAX_INLINE void xx_to_chdr_sc16(const std::complex<T>* input,
    sc16_t* output,
    const size_t nsamps,
    const double scale_factor)
{
 ...
 **********************************************************************/
template <typename T>
PAX_INLINE std::complex<T> item32_sc16_x1_to_xx(
...
template <>
PAX_INLINE sc16_t item32_sc16_x1_to_xx(const item32_t item, const double)
{
    return sc16_t(int16_t(item >> 16), int16_t(item >> 0));
}

template <xtox_t to_host, typename T>
PAX_INLINE void item32_sc16_to_xx(const item32_t* input,
...
template <typename T>
PAX_INLINE std::complex<T> chdr_sc16_x1_to_xx(
...
template <typename T>
PAX_INLINE void chdr_sc16_to_xx(const sc16_t* input,
    std::complex<T>* output,
    const size_t nsamps,
    const double scale_factor)
{
 ...
 **********************************************************************/
template <typename T>
PAX_INLINE item32_t xx_to_item32_sc8_x1(
...
template <>
PAX_INLINE item32_t xx_to_item32_sc8_x1(const sc8_t& in0, const sc8_t& in1, const double)
{
    uint8_t real1 = int8_t(in0.real());
    uint8_t imag1 = int8_t(in0.imag());
    uint8_t real0 = int8_t(in1.real());
...
template <xtox_t to_wire, typename T>
PAX_INLINE void xx_to_item32_sc8(const std::complex<T>* input,
    item32_t* output,
    const size_t nsamps,
    const double scale_factor)
{
 ...
 **********************************************************************/
template <typename T>
PAX_INLINE void item32_sc8_x1_to_xx(const item32_t item,
    std::complex<T>& out0,
    std::complex<T>& out1,
    const double scale_factor)
{
...
template <>
PAX_INLINE void item32_sc8_x1_to_xx(
...
template <xtox_t to_host, typename T>
PAX_INLINE void item32_sc8_to_xx(const item32_t* input,
    std::complex<T>* output,
    const size_t nsamps,
    const double scale_factor)
{
...
#endif /* INCLUDED_LIBPAX_CONVERT_COMMON_HPP */
