...
PAX_INLINE long long fast_llround(const double x){
...
bool pax::operator==(const time_spec_t &lhs, const time_spec_t &rhs){
    return
...
PAX_API time_t time_spec_t::get_full_secs(void) const{
    return this->_full_secs;
}

PAX_API double time_spec_t::get_frac_secs(void) const{
