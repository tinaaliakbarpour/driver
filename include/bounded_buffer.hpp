...
#ifndef INCLUDED_PAX_TRANSPORT_BOUNDED_BUFFER_HPP
#define INCLUDED_PAX_TRANSPORT_BOUNDED_BUFFER_HPP

#include <bounded_buffer.ipp> //detail
...
#endif /* INCLUDED_PAX_TRANSPORT_BOUNDED_BUFFER_HPP */
