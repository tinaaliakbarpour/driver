...
#include <frame_buff.hpp>
#include <memory>

#ifndef INCLUDED_PAXLIB_TRANSPORT_LINK_IF_HPP
#    define INCLUDED_PAXLIB_TRANSPORT_LINK_IF_HPP
...
#endif /* INCLUDED_PAXLIB_TRANSPORT_LINK_IF_HPP */
