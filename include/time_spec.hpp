...
#ifndef INCLUDED_PAX_TYPES_TIME_SPEC_HPP
#define INCLUDED_PAX_TYPES_TIME_SPEC_HPP
...
namespace pax{
     ...
     */
    class PAX_API time_spec_t : boost::additive<time_spec_t>, boost::totally_ordered<time_spec_t>{
    public:
    ...
    PAX_API bool operator==(const time_spec_t &, const time_spec_t &);
...
#endif /* INCLUDED_PAX_TYPES_TIME_SPEC_HPP */
