...
#ifndef INCLUDED_PAX_TYPES_RANGES_HPP
#define INCLUDED_PAX_TYPES_RANGES_HPP
...
namespace pax{
     ...
     */
    struct PAX_API meta_range_t : std::vector<range_t>{
...
#endif /* INCLUDED_PAX_TYPES_RANGES_HPP */
