...
#ifndef INCLUDED_PAX_TRANSPORT_UDP_SIMPLE_HPP
#define INCLUDED_PAX_TRANSPORT_UDP_SIMPLE_HPP
...
class PAX_API udp_simple : pax::noncopyable
{
public:
...
#endif /* INCLUDED_PAX_TRANSPORT_UDP_SIMPLE_HPP */
