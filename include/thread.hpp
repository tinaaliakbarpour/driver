 ...
 */
PAX_API void set_thread_name(boost::thread* thread, const std::string& name);
 ...
 * \param name thread name with maximum length of 16 characters
 */
PAX_API void set_thread_name(std::thread* thread, const std::string& name);
 ...
 */
PAX_API void set_thread_affinity(const std::vector<size_t>& cpu_affinity_list);
