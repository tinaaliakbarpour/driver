...
#ifndef INCLUDED_PAX_STREAM_HPP
#define INCLUDED_PAX_STREAM_HPP
 ...
 */
class PAX_API rx_streamer : boost::noncopyable{
public:
 ...
 */
class PAX_API tx_streamer : boost::noncopyable{
public:
