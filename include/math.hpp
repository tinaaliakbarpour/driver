 ...
 * be used in PAX when portable / `std` options are not available.
 */
namespace math {
     ...
     * data types for portability across PAX.
     */
...
namespace fp_compare {
     ...
     * equality, and in the end it all comes down to the domain at hand. PAX's
     ...
     *      [(|u - v| / |u|) <= e] && [(|u - v| / |v|) <= e]
     *
     * PAX's modification to this algorithm is using the denominator's epsilon
