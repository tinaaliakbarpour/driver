...
#ifndef INCLUDED_PAX_TYPES_REF_VECTOR_HPP
#define INCLUDED_PAX_TYPES_REF_VECTOR_HPP
 ...
 */
template <typename T> class PAX_API ref_vector{
public:
    /*!
...
#endif /* INCLUDED_PAX_TYPES_REF_VECTOR_HPP */
