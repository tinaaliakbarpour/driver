...
#ifndef INCLUDED_PAX_TRANSPORT_ZERO_COPY_HPP
#define INCLUDED_PAX_TRANSPORT_ZERO_COPY_HPP
...
public:
    ...
    template <typename T>
    PAX_INLINE boost::intrusive_ptr<T> make(T* p, void* buffer, size_t length)
    {
        _buffer = buffer;
        _length = length;
 ...
 */
class PAX_API zero_copy_if : pax::noncopyable
{
public:
...
#endif /* INCLUDED_PAX_TRANSPORT_ZERO_COPY_HPP */
