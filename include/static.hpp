...
#ifndef INCLUDED_PAX_UTILS_STATIC_HPP
#define INCLUDED_PAX_UTILS_STATIC_HPP
 ...
 */
#define PAX_SINGLETON_FCN(_t, _x) static _t &_x(){static _t _x; return _x;}
 ...
 */
#define PAX_STATIC_BLOCK(_x) \
    void _x(void); \
    static _pax_static_fixture _x##_fixture(&_x, #_x); \
    void _x(void)

//! Helper for static block, constructor calls function
struct PAX_API _pax_static_fixture{
    _pax_static_fixture(void (*)(void), const char *);
};

#endif /* INCLUDED_PAX_UTILS_STATIC_HPP */
