...
#ifndef INCLUDED_PAX_CONVERT_HPP
#define INCLUDED_PAX_CONVERT_HPP
...
struct PAX_API id_type : boost::equality_comparable<id_type>
{
 ...
 */
PAX_API function_type get_converter(const id_type& id, const priority_type prio = -1);
 ...
 */
PAX_API void register_bytes_per_item(const std::string& format, const size_t size);

//! Convert an item format to a size in bytes
PAX_API size_t get_bytes_per_item(const std::string& format);

}} // namespace pax::convert

#endif /* INCLUDED_PAX_CONVERT_HPP */