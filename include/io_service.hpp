 ...
 *    (pax::transport::recv_link_if and pax::transport::send_link_if) provide
 ...
 *    (pax::transport::io_service). Transports implement callbacks defined by
 ...
 * pax::transport::recv_io_if and pax::transport::send_io_if interfaces.
 */


#ifndef INCLUDED_PAXLIB_TRANSPORT_IO_SERVICE_HPP
#define INCLUDED_PAXLIB_TRANSPORT_IO_SERVICE_HPP
 ...
 * for data reception, and the pax::transport::recv_callback_t and
 * recv_io_if::fc_callback_t are available for handling flow control and
 * automatic responses. The pax::transport::recv_callback_t also indicates
 ...
 * for data transmission, and the pax::transport::recv_callback_t and
 * send_io_if::send_callback_t are available for handling flow control and
 * receiving side-band messages. Currently, the pax::transport::recv_callback_t
...
#endif /* INCLUDED_PAXLIB_TRANSPORT_IO_SERVICE_HPP */
