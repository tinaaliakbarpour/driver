...
#ifndef INCLUDED_PAX_TYPES_METADATA_HPP
#define INCLUDED_PAX_TYPES_METADATA_HPP
...
namespace pax{
     ...
     */
    struct PAX_API async_metadata_t{
...
#endif /* INCLUDED_PAX_TYPES_METADATA_HPP */
