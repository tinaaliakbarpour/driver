...
namespace pax { namespace transport { namespace vrt {
 ...
 */
PAX_API void if_hdr_pack_be(uint32_t* packet_buff, if_packet_info_t& if_packet_info);
 ...
 * \param if_packet_info the if packet info (read/write)
 */
PAX_API void if_hdr_pack_le(uint32_t* packet_buff, if_packet_info_t& if_packet_info);
