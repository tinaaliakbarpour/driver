...
########################################################################
INCLUDE(PAXVersion) #sets version information

SET(PAX_RELEASE_MODE "${PAX_RELEASE_MODE}" CACHE BOOL "set PAX to release mode to build installers")
...
IF(DEBIAN AND LIBPAX_PKG)
    SET(CPACK_PACKAGE_FILE_NAME "libpax${PAX_VERSION_MAJOR}_${TRIMMED_PAX_VERSION}_${CMAKE_SYSTEM_PROCESSOR}")
ELSEIF(DEBIAN AND LIBPAXDEV_PKG)
    SET(CPACK_PACKAGE_FILE_NAME "libpax-dev_${TRIMMED_PAX_VERSION}_${CMAKE_SYSTEM_PROCESSOR}")
ELSEIF(DEBIAN AND PAXHOST_PKG)
    SET(CPACK_PACKAGE_FILE_NAME "pax-host_${TRIMMED_PAX_VERSION}_${CMAKE_SYSTEM_PROCESSOR}")
ELSE()
    IF(DEBIAN OR REDHAT)
        ...
        IF(LSB_RELEASE_EXECUTABLE)
            ...
            SET(CPACK_PACKAGE_FILE_NAME "pax_${PAX_VERSION}_${LSB_ID}-${LSB_RELEASE}-${CMAKE_SYSTEM_PROCESSOR}")
        ENDIF(LSB_RELEASE_EXECUTABLE)
    ENDIF(DEBIAN OR REDHAT)
ENDIF(DEBIAN AND LIBPAX_PKG)
...
IF(${CPACK_GENERATOR} STREQUAL NSIS)
    ...
    IF(SPECIFY_MSVC_VERSION)
        ...
        ENDIF()
        SET(CPACK_PACKAGE_FILE_NAME "pax_${PAX_VERSION}_Win${BIT_WIDTH}_${MSVC_VERSION}")
    ELSE()
        SET(CPACK_PACKAGE_FILE_NAME "pax_${PAX_VERSION}_Win${BIT_WIDTH}")
...
# Setup CPack General
########################################################################
SET(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Partocom Asia - PAX Hardware Driver")
SET(CPACK_PACKAGE_VENDOR              "Partocom Asia LLC")
SET(CPACK_PACKAGE_CONTACT             "Mohammad Amirrahmat <m.amirrahmat@gmail.com>")
SET(CPACK_PACKAGE_VERSION "${PAX_VERSION}")
...
SET(CPACK_SOURCE_PACKAGE_FILE_NAME "pax-${TRIMMED_PAX_VERSION}")
...
SET(CPACK_NSIS_EXTRA_INSTALL_COMMANDS "
    WriteRegStr HKLM ${HLKM_ENV} \\\"PAX_PKG_PATH\\\" \\\"$INSTDIR\\\"
")

SET(CPACK_NSIS_EXTRA_UNINSTALL_COMMANDS "
    DeleteRegValue HKLM ${HLKM_ENV} \\\"PAX_PKG_PATH\\\"
")
